...
extension UIView {
    ...
    public func flipHorizontal(perspectiveDistance: CGFloat = 1000.0) {
        ...
        self.layer.transform = CATransform3DRotate(self.layer.transform, .pi, 0, 1.0, 0)
    }
    ...
    public func flipVertical(perspectiveDistance: CGFloat = 1000.0) {
        self.layer.transform.m34 = -1.0 / perspectiveDistance
        self.layer.transform = CATransform3DRotate(self.layer.transform, .pi, 1.0, 0, 0)
    }
    ...
    public func fadeIn(duration: TimeInterval = Animation.defaultAnimationDuration) -> Animation {
        self.alpha = 0.0
        return AnimationSugar.animate(duration: duration) {
            self.alpha = 1.0
        }
    }
    ...
    public func fadeOut(duration: TimeInterval = Animation.defaultAnimationDuration) -> Animation {
        return AnimationSugar.animate(duration: duration, animations: {
            self.alpha = 0.0
        })
    }
}
